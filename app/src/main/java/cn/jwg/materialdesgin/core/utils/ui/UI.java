...
public class UI {
    ...
    public static LinearLayout.LayoutParams getLinearLayoutPararmW2(int dmw, int w) {
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    ...
    public static LinearLayout.LayoutParams getRelativeLayoutLayoutPararmWT(boolean isByDeviceWidth, int dmw, int dmh, int w, int t, int l) {
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    ...
    public static RelativeLayout.LayoutParams getRelativeLayoutPararmHB(int h, int b) {
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);
    ...
    public static LinearLayout.LayoutParams getRelativeLayoutPararm_Logo(int dmw, int dmh, int w, int h, int t) {
    ...
    public static RelativeLayout.LayoutParams getRelativeLayoutPararmWHBByWidth(int dmw, int dmh, int w, int h, int b) {

        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);

        params.width = dmw * w / ORG_SCREEN_WIDTH;
        params.height = params.width * h / w;
        params.bottomMargin = params.width * b / w;
        return params;
