package cn.jwg.materialdesgin.core.common.views.pickers;
...
import cn.jwg.materialdesgin.core.common.views.wheelview.ArrayWheelAdapter;
...
public class SinglePicker<T> extends WheelPicker {
    ...
    public SinglePicker(Context mContext, T[] items) {
        this(mContext, Arrays.asList(items));
    }

    public SinglePicker(Context mContext, List<T> items) {
        super(mContext);
        setItems(items);
    }
    ...
    public void setItemWidth(int itemWidth) {
        if (wheelModeEnable) {
            if (null != wheelView) {
                int width = UIUtils.toPx(itemWidth);
    ...
    protected View makeCenterView() {
        ...
        if (wheelModeEnable) {
            ...
            wheelView.setDividerColor(mContext.getResources().getColor(R.color.tab_cut_line));
            ...
            wheelListView = new WheelListView(mContext);
