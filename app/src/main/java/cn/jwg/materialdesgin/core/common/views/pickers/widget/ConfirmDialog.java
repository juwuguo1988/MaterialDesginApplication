package cn.jwg.materialdesgin.core.common.views.pickers.widget;
...
public abstract class ConfirmDialog<V extends View> extends BaseDialog<View> {
    ...
    public ConfirmDialog(Context mContext) {
        ...
        submitText = mContext.getString(R.string.sure);
    }
    ...
    protected final View makeContentView() {
        ...
        if (topLineVisible) {
            ...
            int height = UIUtils.toPx(topLineHeight);
    ...
    protected View makeHeaderView() {
        ...
        int height = UIUtils.toPx(topHeight);
        ...
        int padding = UIUtils.toPx(topPadding);
        cancelButton.setPadding(padding, 0, padding, 0);
        if (!TextUtils.isEmpty(cancelText)) {
            cancelButton.setText(cancelText);
        }
        cancelButton.setTextColor(UIUtils.toColorStateList(cancelTextColor, pressedTextColor));
        if (cancelTextSize != 0) {
        ...
        if (null == titleView) {
            ...
            int margin = UIUtils.toPx(topPadding);
        ...
        submitButton.setTextColor(UIUtils.toColorStateList(submitTextColor, pressedTextColor));
        if (submitTextSize != 0) {
